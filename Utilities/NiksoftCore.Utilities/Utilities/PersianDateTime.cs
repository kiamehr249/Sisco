...
namespace NiksoftCore.Utilities
{
	public class PersianDateTime {
		...
		private readonly static string[] dayNames = new string[] { "شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه" };
		private readonly static string[] monthNames = new string[] { "فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند" };
		...
		/// </summary>
		public int Year {
			get { return persianCalendar.GetYear(dateTime); }
		}
		...
		/// </summary>
		public int Month {
			get { return persianCalendar.GetMonth(dateTime); }
		}
		...
		/// </summary>
		public int Day {
			get { return persianCalendar.GetDayOfMonth(dateTime); }
		}
		...
		public int DayOfYear {
			get { return persianCalendar.GetDayOfYear(dateTime); }
		}
		...
		public int DayOfWeek {
			get { return ((int)dateTime.DayOfWeek + 1) % 7; }
		}
		...
		public PersianDateTime Date {
			get { return new PersianDateTime(dateTime.Date); }
		}
		...
		public string ToString(PersianDateTimeFormat format) {
			switch (format) {
				...
				case PersianDateTimeFormat.LongDateFullTime:
					return DayName + " " + Day + " " + MonthName + "- " + TimeOfDay.ToString("HH:MM:SS");

				case PersianDateTimeFormat.LongDateLongTime:
					return DayName + " " + Day + " " + MonthName + "- " + TimeOfDay.ToString("HH:MM");
				...
				case PersianDateTimeFormat.FullDateLongTime:
					return DayName + " " + Day + " " + MonthName + " " + Year + "- " + TimeOfDay.ToString("HH:MM");

				case PersianDateTimeFormat.FullDateFullTime:
					return DayName + " " + Day + " " + MonthName + " " + Year + "- " + TimeOfDay.ToString("HH:MM");
				case PersianDateTimeFormat.MonthNameFull:
		...
		public static string GetTime5Digit() {
			...
			return GetTime5Digit(curDateTime);
		}
	}
}